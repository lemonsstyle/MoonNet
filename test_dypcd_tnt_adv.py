...
conf_all = {'Auditorium':0.1, 'Ballroom':0.15, 'Courtroom':0.15, 'Museum':0.25, 'Palace':0.2, 'Temple':0.05}
dist_all = {'Auditorium':1/2, 'Ballroom':1/4, 'Courtroom':1/2, 'Museum':1/4, 'Palace':1/4, 'Temple':1/4}
rel_diff_all = {'Auditorium':1/1000, 'Ballroom':1/1300, 'Courtroom':1/1000, 'Museum':1/1500, 'Palace':1/1500, 'Temple':1/1500}
fusion_view = {'Auditorium':16, 'Ballroom':16, 'Courtroom':16, 'Museum':11, 'Palace':11, 'Temple':11}
########################################## 
...
parser.add_argument('--testpath', default="your_tnt_path/advanced/", help='testing data dir for some scenes')
parser.add_argument('--testlist', default="lists/tnt/adv.txt",help='testing scene list')

parser.add_argument('--batch_size', type=int, default=1, help='testing batch size')

parser.add_argument('--loadckpt', default=None, help='load a specific checkpoint')
parser.add_argument('--outdir', default='./outputs/tnt', help='output dir')
...
parser.add_argument('--fusion_views', type=int, default=16, help='num of view')
